...
const serviceLinks = [
  { label: 'Real Estate Development', href: '/services/real-estate-development' },
  { label: 'Building & Construction', href: '/services/building-and-construction' },
  { label: 'Land Sales', href: '/services/land-sales' },
  { label: 'Real Estate Investment', href: '/services/real-estate-investment' },
  { label: 'Consultation', href: '/services/real-estate-consultation' },
];
...
=======
              <p className="text-muted-foreground mt-1">Get the latest investment opportunities and estate updates.</p>
>>>>>>> f657e7538ac4c85d88855a9412c8e3d9cc642fec
            </div>
...
=======
              ...
              <p className="text-primary-foreground/60 text-sm leading-relaxed mb-6">Nigeria's premier collective real estate investment platform. Building wealth through smart property investments.</p>
>>>>>>> f657e7538ac4c85d88855a9412c8e3d9cc642fec
...
=======
              <h4 className="font-display font-bold text-primary-foreground mb-5">Services</h4>
              <ul className="space-y-2.5">
...
=======
                <div className="flex items-start gap-2"><MapPin size={14} className="text-gold shrink-0 mt-1" /><p className="text-primary-foreground/60">Wumba, Abuja, FCT</p></div>
                <div className="flex items-start gap-2"><Mail size={14} className="text-gold shrink-0 mt-1" /><div className="text-primary-foreground/60 space-y-1"><p>invest@pros-properties.com</p><p>info@pros-properties.com</p><p>finance@pros-properties.com</p></div></div>
                <div className="flex items-start gap-2"><Phone size={14} className="text-gold shrink-0 mt-1" /><p className="text-primary-foreground/60">+234 816 022 8215</p></div>
>>>>>>> f657e7538ac4c85d88855a9412c8e3d9cc642fec
              </div>
              <div className="mt-6">
...
=======
            <p className="text-primary-foreground/40 text-sm">© {new Date().getFullYear()} Pros Properties Limited. All rights reserved.</p>
            <p className="text-primary-foreground/30 text-xs">Powered by <span className="text-gold/70 font-semibold">AriTron LTD</span></p>
>>>>>>> f657e7538ac4c85d88855a9412c8e3d9cc642fec
          </div>
        </div>
      </div>
