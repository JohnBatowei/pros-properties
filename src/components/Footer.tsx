      ...
      <div className="hero-gradient">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-5">
                <img src={logo} alt="Pros-Properties" className="h-12 w-12" />
        ...
        <div className="border-t border-primary-foreground/10">
          <div className="container-max px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-primary-foreground/30 text-xs">Powered by <a href="https://www.AriTron.com.ng" target="_blank" rel="noopener noreferrer" className="text-gold/70 font-semibold">AriTron LTD</a></p>
          </div>
        </div>
      </div>
    </footer>
